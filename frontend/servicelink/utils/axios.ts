...
api.interceptors.request.use(
    (config: InternalAxiosRequestConfig): InternalAxiosRequestConfig => {
        // A multipart request needs the boundary generated by Axios/the browser.
        // The instance's JSON default would otherwise make Spring reject FormData
        // before it reaches a multipart controller.
