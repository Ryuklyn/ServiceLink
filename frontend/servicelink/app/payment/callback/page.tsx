...
export default function PaymentCallbackPage() {
    return (
        <Suspense fallback={<div className="min-h-[100dvh] flex items-center justify-center text-sm text-slate-500 font-medium bg-[#f0f4fb]">Loading payment details...</div>}>
