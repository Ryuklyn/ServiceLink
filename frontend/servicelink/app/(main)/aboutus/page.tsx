    ...
    return (
        <div className="bg-white">
            ...
            <span className="text-sm font-bold uppercase tracking-wider text-[#e8683f]">
              Our Story
                        ...
                        <h1 className="mt-2 text-3xl sm:text-4xl font-extrabold leading-tight">
                            <span className="text-[#1e3a8a]">Built in Nepal.</span>
                            <br />
                            <span className="text-[#1e3a8a]">Built </span>
                            <span className="text-[#e8683f]">for</span>{" "}
                            <span className="text-[#1e3a8a]">Nepal.</span>
                        </h1>
                        <p className="mt-4 text-gray-600 text-sm leading-relaxed max-w-md">
                            ServiceLink started with a simple frustration — finding a
                            reliable plumber, electrician, or cleaner in Kathmandu
                            shouldn&apos;t be this hard. So we built the platform we wished
                            existed.
                        </p>
                    </div>
                    ...
                    <div className="relative h-56 sm:h-64 rounded-2xl overflow-hidden">
                        <img
                            ...
                            alt="Kathmandu Durbar Square with Himalayan mountains"
          ...
          <span className="text-sm font-bold uppercase tracking-wider text-[#e8683f]">
            ...
            {/* Founder Section */}
            <section className="bg-gray-50 py-16">
                <div className="max-w-5xl mx-auto px-4 lg:px-8 grid sm:grid-cols-[200px_1fr] gap-8 items-start">
                    <Image
                        src="/images/Rukesh.webp"
                        alt="Rukesh Maharjan, founder"
                        width={800}
                        height={800}
                        className="w-full h-100 sm:h-56 rounded-2xl object-cover"
                    />
                    <div>
            <span className="text-sm font-bold uppercase tracking-wider text-[#e8683f]">
              Who Built This
                        ...
                        <h2 className="mt-2 text-xl sm:text-2xl font-extrabold text-[#1e3a8a]">
                            Made by a Developer Who Understood the Problem
                        </h2>

                        <p className="mt-3 text-sm text-gray-600 leading-relaxed">
                            ServiceLink Nepal was designed and built by Rukesh Maharjan, a
                            final-semester BICT student at Virinchi College, Lalitpur — as
                            both a final year project and a genuine attempt to solve a
                            real problem in Nepal&apos;s local services economy.
                        </p>
                        <p className="mt-3 text-sm text-gray-600 leading-relaxed">
                            With hands-on experience in full stack development, a
                            certified background in Solana blockchain development, and a
                            3-month internship at Panda Infosys — ServiceLink reflects
                            what happens when technical skill meets a problem worth
                            solving.
                        </p>
                        <p className="mt-3 text-sm font-semibold text-gray-800">
                            This isn&apos;t just a college project. It&apos;s a platform
                            built to work.
                        </p>
                        ...
                        <div className="mt-5 flex flex-wrap gap-4">
                            ...
                            className="flex items-center gap-2 border border-gray-200 rounded-lg px-4 py-2.5 bg-white hover:bg-gray-50 transition"
                            >
                  ...
                  <span className="text-gray-500 text-xs">
                    linkedin.com/in/rukesh-maharjan
                  </span>
                </span>
                    </a>
                </div>
    ...
    <section className="pb-16">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 grid lg:grid-cols-[1fr_1fr_1fr] gap-8">
            ...
            {/*<Instagram className="w-4 h-4 text-pink-600" />*/}
                <svg className="w-4 h-4 text-pink-600" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
