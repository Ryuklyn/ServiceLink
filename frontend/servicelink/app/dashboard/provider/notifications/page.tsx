...
export default function ProviderNotificationsPage() {
    ...
    // ⚠️ Adjust field name if your ProviderProfile DTO calls this differently (e.g. profile.userId, profile.user.id)
    const recipientId = provider?.userId;
    const role = "PROVIDER";
                            ...
                            return (
                                <li
                                    ...
                                    className={`flex items-center gap-4 px-6 py-4 cursor-pointer transition-colors ${
                                        !notif.isRead ? "bg-[#e8683f]/5 hover:bg-[#e8683f]/10" : "hover:bg-gray-50"
                                    }`}
                                >
                                    ...
                                    {!notif.isRead && <span className="w-2.5 h-2.5 rounded-full bg-[#1e3a8a] shrink-0" />}
                                </li>
                            );
                        })}
                    </ul>
