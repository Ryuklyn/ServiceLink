    ...
    <div className="min-h-[100dvh] w-full flex flex-col lg:flex-row bg-white overflow-hidden">
      ...
      <div className="hidden lg:flex flex-1 relative bg-linear-to-br from-[#1e3a8a] to-[#2563eb] items-center justify-center p-12 text-center text-white">
        ...
        <div className="relative z-10 max-w-sm flex flex-col items-center">
          {/* ↓ Changed: shield icon instead of hard-hat */}
          ...
          {/* ↓ Changed: login-specific headline & body copy */}
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-10 bg-[#f0f4ff] overflow-y-auto">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-[#1e3a8a]/15 overflow-hidden">
          ...
          <div className="px-6 py-6 space-y-5">
            ...
            {/* ── Info box — ↓ Changed: login-specific copy ── */}
            <div
              role="note"
              ...
              <p className="text-[#1e3a8a]/70 text-xs leading-relaxed">
                {mode === "phone" ? (
                  <>
                    ...
                    registered provider numbers are accepted. {/* ↓ Changed */}
                  </>
                ) : (
                  <>
                    ...
                    spam folder if it doesn't arrive. {/* ↓ Changed */}
                  </>
                )}
              </p>
            </div>
            ...
            {whatsappLink && (
              <div className="rounded-xl border-2 border-green-300 bg-green-50 p-4 space-y-3">
                ...
                >
                  I've noted my code → Continue to verify {/* ↓ Changed */}
                </button>
              </div>
            )}

            {/* ── Send button — ↓ Changed: label ── */}
            {!whatsappLink && (
              <button
                onClick={handleSend}
                disabled={isDisabled}
                ...
                {loading ? (
                  <>
                    <span
                      ...
                      aria-hidden
                    />
                    <span>Sending Login Code…</span> {/* ↓ Changed */}
                  </>
                ) : (
                  <>
                    <LogIn size={17} aria-hidden />{" "}
                    {/* ↓ Changed: LogIn icon instead of Phone/Mail */}
                    <span>Send Login Code</span> {/* ↓ Changed */}
          ...
          {/* Footer — ↓ Changed: "Don't have an account?" instead of "Already registered?" */}
