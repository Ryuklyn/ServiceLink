...
export default function Hero() {
  ...
  return (
      <section className="bg-gradient-to-br from-[#1e3a8a] to-[#1e40af] text-white pt-24 pb-28 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 grid lg:grid-cols-[45%_55%] gap-12 lg:gap-8 items-center relative z-10">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg text-white/80 max-w-lg leading-relaxed">
              ...
              and 50+ services across Nepal. Secure digital payments via eSewa
              and Khalti.
            </p>

            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <Link href="/login/user" passHref>
                <button className="w-full sm:w-auto bg-accent-400 hover:bg-accent-500 text-white font-semibold flex items-center justify-center px-6 py-3.5 rounded-xl shadow-lg shadow-[#e8683f]/30 transition-all group whitespace-nowrap">
                  Book a Service
          ...
          <div className="hidden md:block relative w-full lg:w-[100%] lg:pl-10">
