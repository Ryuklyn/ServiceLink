              ...
              {filtered.map((provider) => (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap sm:flex-nowrap gap-2 pt-1">
                      ...
                      {/* WhatsApp Button with Brand-accurate SVG */}
                      <button className="flex-none bg-green-500 hover:bg-green-600 text-white p-2 sm:px-3 sm:py-2 rounded-xl text-xs sm:text-sm font-semibold transition-colors flex items-center justify-center gap-1.5" title="Chat on WhatsApp">
                        <svg
