...
export default function BookingSidebar({
    ...
    // Local mirrors for date/period — kept in sync via useEffect
    ...
    // ── Media Upload (max 1 file, image or video) ────────────────────────────────
    ...
    return (
        <div className="bg-white border border-gray-100 rounded-2xl shadow-sm flex flex-col gap-0 overflow-hidden max-w-sm w-full">
            ...
            <div className="flex flex-col gap-0 divide-y divide-gray-100">
                ...
                <div className="px-5 py-4">
                    ...
                    Rs. {svc.priceMin.toLocaleString()}
                        ...
                        /* Empty state — prompt user to select services */
                        <div className="flex flex-col items-center justify-center gap-2 border-2 border-dashed border-gray-200 rounded-xl py-5 px-3 text-center">
                            ...
                            <p className="text-[11px] text-gray-400 leading-snug">
                                Click the <span className="font-bold text-[#e8683f]">Add</span> button next to any service below to include it in your booking.
                            </p>
                        </div>
                    )}
                </div>
            ...
            />
                ...
                {/* ── Photo or Video (max 1) ── */}
                <div className="px-5 py-4">
                    <p className="text-xs font-semibold text-gray-500 mb-2">
                        Photo or Video{" "}
                        <span className="font-normal text-gray-400">(optional, max 1)</span>
                    </p>
                    <input
                        ref={fileInputRef}
                        type="file"
                    ...
                    <span className="text-xs font-semibold text-green-700">
                      1 item attached
                                        ...
                                        <span className="text-[10px] text-green-600/70 truncate max-w-[140px]">
                      {media.file.name}
                    </span>
                                    </div>
                                </div>
                                <button
                                    onClick={removeMedia}
                                    type="button"
                                    className="w-5 h-5 bg-gray-200 text-gray-600 rounded-full flex items-center justify-center hover:bg-red-100 hover:text-red-500 transition-colors"
                                >
                                    <X size={10} />
                                </button>
                            </div>
                            ...
                            <button
                                onClick={() => fileInputRef.current?.click()}
                                type="button"
                                className="text-[11px] text-[#1e3a8a] font-semibold text-center hover:underline"
                            >
                                Replace file
                            </button>
                        </div>
                ...
                <div className="px-5 py-4 flex gap-2">
                    ...
                    <div className="flex-1 bg-gray-50 border border-gray-200 rounded-xl px-3 py-2.5">
                        ...
                        {periodInfo ? (
                            <p className="text-sm font-bold text-gray-900 mt-0.5">
                                {periodInfo.label}{" "}
                                <span className="text-gray-400 font-normal text-xs">({periodInfo.time})</span>
                            </p>
                        ) : (
                            <p className="text-xs text-gray-400 mt-0.5 italic">Not selected</p>
                        )}
                ...
                <div className="px-5 py-4">
                    ...
                    >
                        <MapPin size={13} />
                        {showMap ? "Hide Map" : "Pin on Live Map"}
                    </button>
                    ...
                    {showMap && (
                        <div className="mt-2 rounded-xl overflow-hidden border border-gray-200 h-44">
                            <MapContainer
                                ...
                                zoom={15}
                                style={{ height: "100%", width: "100%" }}
                                whenReady={(mapInstance: any) => { mapRef.current = mapInstance.target; }}
                            >
                                <TileLayer
                        ...
                        <div className="flex flex-col text-[11px] bg-white divide-y divide-slate-100">
                            ...
                            <div className="grid grid-cols-2 divide-x divide-slate-100">
                                <div className="p-3 text-center">
                                    <div className="text-gray-400 font-medium mb-1.5 leading-tight">
                                        Under 24 hrs
                                        <span className="text-slate-500 block font-semibold">Reschedule</span>
                                    </div>
                                ...
                                <div className="p-3 text-center">
                                    <div className="text-gray-400 font-medium mb-1.5 leading-tight">
                                        Under 24 hrs
                                        <span className="text-slate-500 block font-semibold">Cancel</span>
                                    </div>
                ...
                <div className="px-5 py-4 flex flex-col gap-2">
                    <button
                        ...
                        type="button"
                        className="w-full bg-[#e8683f] hover:bg-[#d75930] disabled:opacity-40 disabled:cursor-not-allowed text-white font-bold py-3.5 rounded-xl text-sm transition-colors shadow-sm"
                    >
                        {hasServices ? "Book Now" : "Select Services to Book"}
                    </button>
                    <div className="flex gap-2">
                        <button
                            type="button"
