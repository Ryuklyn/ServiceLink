    ...
    <div className="w-full">
      ...
      <div className="flex items-start gap-4 mb-8">
        <div className="w-12 h-12 rounded-full bg-[#e8edf8] flex items-center justify-center shrink-0">
          <Building2 size={22} className="text-[#1e2d5a]" />
        </div>
        <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <div>
            ...
            <div className="relative">
              <select className="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm text-gray-400 appearance-none focus:outline-none focus:ring-2 focus:ring-[#f26522]/40 focus:border-[#f26522] transition bg-white">
